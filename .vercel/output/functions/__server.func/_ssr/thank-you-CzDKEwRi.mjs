...
import { c as WhatsAppIcon, s as Route$7 } from "./router-DVre9Y2s.mjs";
import { _ as contactInfo, d as countries, h as popularDestinations } from "./router-DVre9Y2s2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/thank-you-CzDKEwRi.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative mx-auto max-w-3xl rounded-2xl border border-border bg-card p-6 sm:p-12 shadow-lg text-center",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "inline-flex items-center justify-center p-3 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-600 mb-6 animate-in zoom-in-75 duration-300",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "rounded-full bg-emerald-600 p-2.5 text-white shadow-lg shadow-emerald-600/30",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-8 w-8 stroke-[2.5]" })
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "inline-flex items-center gap-1.5 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700 mb-4",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mx-auto mt-5 inline-flex items-center gap-2 rounded-xl border border-border bg-slate-50 px-4 py-2 text-xs text-muted-foreground",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WhatsAppIcon, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Open WhatsApp Directly" })]
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-4 pt-4 border-t border-border/50 text-xs font-semibold text-emerald-700",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-4 pt-4 border-t border-border/50 text-xs font-semibold text-primary",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-4 pt-4 border-t border-border/50 text-xs font-semibold text-foreground",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-8 rounded-2xl border border-border bg-card p-5 shadow-xs",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
