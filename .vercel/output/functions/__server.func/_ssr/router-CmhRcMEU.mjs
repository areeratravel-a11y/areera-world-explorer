...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-CmhRcMEU.js
...
var styles_default = "/assets/styles-SOvMyeoc.css";
...
function trackEvent(eventName, params = {}) {
	...
	if (typeof window !== "undefined" && typeof window.clarity === "function") try {
...
function AiTravelAdvisor() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "fixed bottom-24 right-4 z-40 md:bottom-8 md:right-8 print:hidden",
		children: !isOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-2 rounded-full bg-[#0b101b] px-4 py-2.5 text-white transition-colors group-hover:bg-[#101726]",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { className: "h-4 w-4 text-emerald-400 transition-transform group-hover:rotate-12" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-xs font-semibold tracking-wide sm:text-sm",
						children: "Ask Areera AI"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-3.5 w-3.5 text-amber-400 animate-pulse" })
				]
			})
		})
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between border-b border-white/10 bg-gradient-to-r from-[#0d1424] via-[#0e172a] to-[#0d1424] px-4 py-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 text-emerald-400",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { className: "h-5 w-5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute -bottom-0.5 -right-0.5 h-2.5 w-2.5 rounded-full bg-emerald-500 ring-2 ring-[#090d16]" })]
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								...
								className: "inline-flex items-center rounded-md bg-emerald-500/10 px-1.5 py-0.5 text-[10px] font-medium text-emerald-400 ring-1 ring-inset ring-emerald-500/20",
								children: "24/7 LLM Intelligence"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						currentCountry && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "rounded-xl border border-emerald-500/20 bg-emerald-950/20 p-2.5 flex items-center justify-between text-emerald-300",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-base",
						...
						messages.map((msg) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: cn("max-w-[88%] rounded-2xl px-3.5 py-2.5 leading-relaxed", msg.sender === "user" ? "bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-br-xs" : "bg-white/5 border border-white/10 text-gray-200 rounded-bl-xs shadow-xs"),
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "whitespace-pre-wrap",
										children: msg.text
									}), msg.suggestedLink && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-2.5 pt-2 border-t border-white/10",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								...
								msg.actionChips && msg.actionChips.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: msg.actionChips.map((chip, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										children: [chip.includes("WhatsApp") || chip.includes("Consultant") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "h-2.5 w-2.5 text-emerald-400" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-2.5 w-2.5 text-amber-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: chip })]
									}, idx))
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						isTyping && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 text-gray-400 bg-white/5 border border-white/10 rounded-2xl px-3.5 py-2.5 w-fit",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { className: "h-3.5 w-3.5 text-emerald-400 animate-spin" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-xs",
				...
				!hasInteracted && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-[10px] text-gray-400 mb-1.5 font-medium",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between border-t border-white/10 bg-[#0c121f] px-4 py-2 text-[11px]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "text-gray-400 flex items-center gap-1.5",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "h-3.5 w-3.5 text-emerald-400" }), "Prefer a human specialist?"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "p-3 border-t border-white/10 bg-[#080b13]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						...
						className: "mt-1.5 flex items-center justify-between text-[9px] text-gray-500 px-1",
...
var $$splitComponentImporter$15 = () => import("./routes-C2lxFc6k.mjs");
...
var $$splitComponentImporter$13 = () => import("./contact-CRJZ3wnZ.mjs");
...
var $$splitErrorComponentImporter = () => import("./countries-B3Q-68jo.mjs");
...
var $$splitComponentImporter$11 = () => import("./flight-reservation-BKeRVw25.mjs");
...
var $$splitComponentImporter$10 = () => import("./hotel-booking-D9PmDJev.mjs");
...
var $$splitComponentImporter$9 = () => import("./privacy-policy-BSgXemWy.mjs");
...
var $$splitComponentImporter$8 = () => import("./terms-and-conditions-cIUjarSw.mjs");
...
var $$splitComponentImporter$7 = () => import("./thank-you-Bz-TEBsy.mjs");
...
var $$splitComponentImporter$5 = () => import("./countries._slug-C3g3k5if.mjs");
var $$splitNotFoundComponentImporter = () => import("./countries._slug-1ga8y83e.mjs");
...
var $$splitComponentImporter$4 = () => import("./guides.visa-free-asian-destinations-CFnkbXAf.mjs");
...
var $$splitComponentImporter$2 = () => import("./services.attestation-DkXYEq2Q.mjs");
...
var $$splitComponentImporter$1 = () => import("./services.ticket-ZIftNopY.mjs");
...
var $$splitComponentImporter = () => import("./services.visa-CRTvBC2c.mjs");
...
//#endregion
export { Route$15 as a, getRouter as c, trackWhatsAppContact as d, Route$14 as i, router_exports as l, NotFoundPage as n, Route$5 as o, Route as r, Route$7 as s, CountriesSkeleton as t, trackInquirySubmitted as u };
