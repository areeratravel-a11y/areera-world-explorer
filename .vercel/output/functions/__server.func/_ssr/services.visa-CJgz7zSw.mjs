...
import { R as FileCheckCorner, S as PhoneCall, V as Earth, f as ShieldCheck, l as Stamp, nt as BadgeCheck, rt as ArrowRight } from "../_libs/lucide-react.mjs";
...
import { r as Route } from "./router-DVre9Y2s.mjs";
import { H as visaArticle, U as visaFaqs, W as Button, _ as contactInfo, d as countries, g as popularVisaDestinations, s as CountryFlag } from "./router-DVre9Y2s2.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/services.visa-CJgz7zSw.js
...
function VisaPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mb-10 flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-border bg-gradient-to-r from-card via-card to-primary/5 p-5 sm:p-6 shadow-sm",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-3.5",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "h-12 w-12 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center justify-center text-emerald-600 shrink-0",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BadgeCheck, { className: "h-6 w-6" })
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "relative flex h-2 w-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-500 opacity-75" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "relative inline-flex h-2 w-2 rounded-full bg-emerald-600" })]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
					...
					target: "_blank",
					rel: "noreferrer",
					className: "inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-300 bg-emerald-50 px-4 py-2.5 text-xs sm:text-sm font-semibold text-emerald-700 hover:bg-emerald-100 transition-colors",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PhoneCall, { className: "h-3.5 w-3.5 text-emerald-600" }), "WhatsApp Specialist"]
				})]
			})]
		}),
		selected ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mb-10 flex items-center justify-between gap-4 rounded-2xl border border-blue-200/80 bg-gradient-to-r from-blue-50/80 via-white to-blue-50/40 p-6 shadow-sm",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CountryFlag, {
					...
					size: "lg",
					className: "ring-1 ring-blue-300 shadow-sm"
				...
				className: "hidden sm:inline-flex items-center gap-1 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileCheckCorner, { className: "h-6 w-6 text-emerald-600" })]
					...
					children: [
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "mt-0.5 h-4 w-4 shrink-0 text-emerald-600" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: d })]
					}, d))
				})]
			})]
		}),
