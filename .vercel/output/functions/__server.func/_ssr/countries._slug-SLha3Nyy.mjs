...
import { A as Headphones, B as CalendarClock, D as Hotel, F as Clock, I as CircleCheck, M as Earth, N as Compass, P as Coins, T as Landmark, U as BadgeCheck, V as Building2, c as Sparkles, h as PlaneTakeoff, j as FileCheckCorner, m as Plane, r as Wallet, s as Stamp, u as ShieldAlert, v as MessageSquare, x as MapPin, z as Calendar } from "../_libs/lucide-react.mjs";
...
import { f as countries, i as Route$4, n as CountryFlag, p as countriesByRegion, u as REGION_SLUGS } from "./router-DvzRRJhh.mjs";
import { C as regionArticle, g as countryFaqs, h as countryArticle, i as siteConfig } from "./router-DvzRRJhh2.mjs";
import { t as CountryCard } from "./cards-B4A5MG33.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/countries._slug-SLha3Nyy.js
	...
	if (data.kind === "region") {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative mb-10 overflow-hidden rounded-3xl border border-border/80 bg-gradient-to-br from-card/90 via-navy/70 to-navy-deep p-6 sm:p-10 shadow-lg backdrop-blur-xl",
				children: [
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "h-full rounded-3xl border border-border/80 bg-card/75 p-6 sm:p-8 shadow-sm backdrop-blur-md",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center justify-between",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mt-16 rounded-3xl border border-border/80 bg-card/60 p-6 sm:p-8 shadow-sm backdrop-blur-md",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mt-16 relative overflow-hidden rounded-3xl border border-primary/40 bg-gradient-to-br from-primary/15 via-card to-navy-deep p-6 sm:p-10 shadow-xl",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "mt-1 text-xs text-muted-foreground",
									children: "Best airfares on leading carriers"
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
