	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative rounded-2xl border border-border bg-card p-6 sm:p-12 shadow-sm mb-12",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "These Terms and Conditions constitute a legally binding service agreement between Areera Travel and Tours (\"Areera Travel\", \"we\", \"us\", or \"our\") and the client (\"you\", \"user\", or \"applicant\"). By requesting or utilizing our visa assistance, air ticketing, hotel voucher issuance, or consular attestation services, you acknowledge that you have read, understood, and agreed to be bound by these provisions."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-6 flex flex-wrap items-center gap-4 text-xs text-muted-foreground pt-4 border-t border-border",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-2xl border border-amber-200 bg-amber-50 p-4 mb-4 text-xs sm:text-sm text-amber-900 flex items-start gap-3",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, { className: "h-5 w-5 shrink-0 text-amber-600 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
										className: "font-semibold block text-amber-950",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-16 rounded-2xl border border-border bg-card/60 p-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground",
