...
import { $ as Building2, E as MapPin, H as Compass, I as Headphones, K as CircleCheck, N as Hotel, Q as CalendarClock, R as FileCheckCorner, U as Coins, V as Earth, W as Clock, Z as Calendar, b as PlaneTakeoff, j as Landmark, l as Stamp, nt as BadgeCheck, p as ShieldAlert, r as Wallet, rt as ArrowRight, y as Plane } from "../_libs/lucide-react.mjs";
...
import { c as WhatsAppIcon, o as Route$5 } from "./router-F7AE0Etm.mjs";
import { A as countryFaqs, L as regionArticle, W as Button, d as countries, f as countriesByRegion, k as countryArticle, l as REGION_SLUGS, s as CountryFlag, y as siteConfig } from "./router-F7AE0Etm2.mjs";
import { t as CountryCard } from "./cards-CNZ1sMux.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/countries._slug-CQCaEor5.js
...
function CountryOrRegion() {
	...
	if (data.kind === "region") {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative mb-10 overflow-hidden rounded-2xl border border-blue-200/80 bg-gradient-to-br from-blue-50/80 via-white to-slate-50 p-6 sm:p-10 shadow-sm",
				children: [
			...
			data.region === "Asia" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-10 rounded-2xl border border-blue-200/90 bg-gradient-to-r from-blue-50/90 via-sky-50/50 to-white p-5 sm:p-6 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "h-10 w-10 rounded-xl bg-blue-100 border border-blue-200 flex items-center justify-center text-blue-600 shrink-0",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/hotel-booking",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Hotel, { className: "mr-2 h-4 w-4 text-primary" }), " Hotel Bookings"]
						})
					})
				]
			}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "relative overflow-hidden border-b border-border/80 bg-gradient-to-b from-blue-50/60 via-background to-background",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			"aria-hidden": true,
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									...
									className: "inline-flex items-center gap-1 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-0.5 text-xs font-semibold text-emerald-700",
									children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "inline-flex items-center gap-1",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Coins, { className: "h-3.5 w-3.5 text-primary" }),
											" Currency:",
											" ",
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
												className: "text-foreground",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									to: "/hotel-booking",
									search: { destination: country.slug },
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Hotel, { className: "mr-2 h-4 w-4 text-primary" }), " Hotels"]
								})
							})
						]
					})]
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: `inline-flex items-center gap-1 rounded-md px-2 py-0.5 text-[11px] font-bold ${vc.typeBadge === "e-Visa" || vc.typeBadge === "Fast Track" ? "bg-emerald-50 text-emerald-700 border border-emerald-200" : "bg-primary/15 text-primary border border-primary/30"}`,
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: country.documents.map((doc, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "mt-0.5 h-4 w-4 shrink-0 text-emerald-600" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: doc })]
						}, doc))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-6 flex items-start gap-2.5 rounded-xl border border-amber-200 bg-amber-50 p-3.5 text-xs text-amber-800",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, { className: "mt-0.5 h-4 w-4 shrink-0 text-amber-600" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Embassy rules and consular requirements may update periodically. Our dedicated consultant double-checks your documents against active mission rules before submission." })]
					})
				]
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BadgeCheck, { className: "h-7 w-7 text-emerald-600" })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-xs text-muted-foreground",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mt-16 relative overflow-hidden rounded-2xl border border-blue-200/90 bg-gradient-to-br from-blue-50/80 via-white to-indigo-50/50 p-6 sm:p-10 shadow-md",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							...
							target: "_blank",
							rel: "noreferrer",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WhatsAppIcon, { className: "mr-2 h-4 w-4 text-[#25D366] group-hover:text-white transition-colors" }), " WhatsApp Inquiry"]
						})
					})]
				})]
			})
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							className: "card-elevate flex flex-col rounded-2xl border border-border/70 bg-background/50 p-4 hover:border-primary/50",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Hotel, { className: "h-5 w-5 text-primary" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "mt-2 font-display text-sm font-bold text-foreground",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							className: "card-elevate flex flex-col rounded-2xl border border-border/70 bg-background/50 p-4 hover:border-primary/50",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Building2, { className: "h-5 w-5 text-emerald-600" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "mt-2 font-display text-sm font-bold text-foreground",
