...
import { h as PlaneTakeoff } from "../_libs/lucide-react.mjs";
...
import { n as Input, r as Label, t as BookingForm } from "./BookingForm-BC3RLmY5.mjs";
import { f as countries, o as Route$7 } from "./router-DvzRRJhh.mjs";
import { _ as flightArticle, v as flightFaqs } from "./router-DvzRRJhh2.mjs";
import { t as RelatedServices } from "./RelatedServices-BYQ1HvMz.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/flight-reservation-DCy5mwDN.js
...
function FlightReservation() {
	const { destination } = Route$7.useSearch();
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeading, {
				...
				children: routes.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "card-elevate flex items-center gap-3 rounded-xl border border-border bg-card/70 p-4",
