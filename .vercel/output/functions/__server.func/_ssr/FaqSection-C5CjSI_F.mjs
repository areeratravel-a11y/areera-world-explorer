	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			intro ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base max-w-prose",
				children: intro
			}) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: sections.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
						className: "relative rounded-2xl border border-border/70 bg-card p-6 sm:p-7 shadow-xs transition-all hover:border-border",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "inline-flex items-center gap-2 rounded-full border border-primary/25 bg-primary/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-primary",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: i + 1
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Step 0", i + 1] })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								className: "mt-3 font-display text-lg font-bold tracking-tight text-foreground sm:text-xl",
								children: s.heading
							}),
							s.paragraphs.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-3 text-sm leading-relaxed text-muted-foreground sm:text-base max-w-prose",
								children: p
							}, p)),
