...
import { F as Headset, K as CircleCheck, R as FileCheckCorner, S as PhoneCall, V as Earth, W as Clock, X as Check, Y as ChevronDown, b as PlaneTakeoff, c as Star, f as ShieldCheck, h as Search, k as LoaderCircle, l as Stamp, m as Send, nt as BadgeCheck, q as CircleAlert, rt as ArrowRight, t as X, tt as BedDouble, x as Phone } from "../_libs/lucide-react.mjs";
...
import { c as WhatsAppIcon } from "./router-DVre9Y2s.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { G as cn, N as homeArticle, P as homeFaqs, W as Button, _ as contactInfo, b as testimonials, d as countries, h as popularDestinations, o as trackWhatsAppContact, r as trackInquirySubmitted, s as CountryFlag, v as services, y as siteConfig } from "./router-DVre9Y2s2.mjs";
import { n as ServiceCard, r as TestimonialCard, t as CountryCard } from "./cards-CNZ1sMux.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Bh2ICYo4.js
...
function HeroBookingCard({ className }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("relative rounded-2xl border border-slate-200/90 bg-white p-6 sm:p-8 shadow-xl shadow-slate-900/5 transition-all", className),
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-wrap items-center justify-between gap-2 border-b border-slate-200/80 pb-4",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-5 grid grid-cols-4 gap-1.5 rounded-2xl bg-slate-100 p-1.5 border border-slate-200/80",
				children: [
					"visa",
					"flight",
					"hotel",
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: cn("flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-1.5 rounded-xl py-2 px-1 sm:px-2.5 text-xs font-medium transition-all", activeService === svc ? "bg-white text-blue-600 shadow-xs font-bold border border-slate-200/80" : "text-slate-600 hover:text-slate-900 hover:bg-white/50"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabIcon, { className: "h-3.5 w-3.5 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: svc === "attestation" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "sm:hidden",
								children: "Attest"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					activeService === "visa" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: cn("relative flex h-12 w-full items-center justify-between rounded-xl border bg-slate-50 px-3.5 py-2 text-xs sm:text-sm text-foreground shadow-xs transition-all cursor-pointer outline-none focus:outline-none", isDropdownOpen ? "border-blue-500 bg-white ring-2 ring-blue-500/20" : "border-slate-300 hover:border-blue-400 hover:bg-white"),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [currentCountry && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CountryFlag, {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											className: "text-xs text-slate-500 hidden xs:inline shrink-0",
											children: [
												"(",
									...
									children: [currentCountry && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "hidden sm:inline-flex items-center gap-1 rounded-full bg-emerald-50 border border-emerald-200 px-2 py-0.5 text-xs font-semibold text-emerald-700",
									...
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: cn("h-4 w-4 text-slate-400 transition-transform duration-200", isDropdownOpen ? "rotate-180 text-blue-600" : "group-hover:text-slate-700") })]
								})]
							}),
							...
							isDropdownOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "absolute left-0 right-0 top-[calc(100%+6px)] z-50 rounded-2xl border border-slate-200 bg-white p-3 shadow-2xl animate-fade-up",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "relative mb-2",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "pointer-events-none absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-blue-600" }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												ref: searchInputRef,
												value: searchQuery,
									...
									!searchQuery && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: destinationFilterTabs.map((tab) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											className: cn("rounded-full px-2.5 py-1 text-xs font-semibold transition-all shrink-0 whitespace-nowrap", selectedFilter === tab.id ? "bg-blue-600 text-white shadow-xs font-bold" : "bg-slate-100 text-slate-600 hover:bg-slate-200 border border-slate-200"),
											children: tab.label
										}, tab.id))
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: filteredCountries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												...
												className: cn("flex w-full items-center justify-between gap-2.5 rounded-xl px-3 py-2 text-xs transition-all text-left group border", isSelected ? "bg-blue-50 border-blue-200 text-blue-900 shadow-xs" : "hover:bg-slate-50 hover:border-slate-200 border-transparent text-slate-800"),
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CountryFlag, {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															className: cn("font-semibold truncate", isSelected ? "text-blue-700" : "text-slate-900 group-hover:text-blue-600"),
															children: c.name
													...
													className: "flex items-center gap-2 shrink-0",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														className: "rounded-full bg-emerald-50 border border-emerald-200 px-2 py-0.5 text-xs font-semibold text-emerald-700",
														children: c.processingTime
													}), isSelected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "h-4 w-4 text-blue-600 shrink-0" })]
												})]
											}, c.slug);
										})
									})
							...
							currentCountry && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-2 flex items-center justify-between text-xs text-slate-500 px-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Processing: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "View Requirements Guide" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, {
										className: "h-3 w-3",
										"aria-hidden": true
									})]
								})]
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: cn("absolute left-3 h-3.5 w-3.5 pointer-events-none transition-colors", phoneError ? "text-destructive" : "text-muted-foreground") }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									...
									className: cn("w-full rounded-xl border bg-white py-2.5 pl-9 pr-3 text-xs sm:text-sm text-foreground transition-colors placeholder:text-muted-foreground focus:outline-none focus:ring-2", phoneError ? "border-destructive focus:border-destructive focus:ring-destructive/30 bg-destructive/5" : "border-slate-300 focus:border-primary focus:ring-primary/20")
								})]
							}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-4 flex flex-wrap items-center justify-between gap-2 pt-3 border-t border-slate-200/80 text-xs text-muted-foreground",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "flex items-center gap-1.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-3.5 w-3.5 text-emerald-600" }), "Zero Filing Fees Until Review"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "flex items-center gap-1.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-3.5 w-3.5 text-blue-600" }), "Average Response: <15 mins"]
				})]
			})
		]
	});
...
function Home() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
												...
												target: "_blank",
												rel: "noreferrer",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WhatsAppIcon, { className: "mr-2 h-4 w-4 text-[#25D366] group-hover:text-white transition-colors" }), " WhatsApp Specialist"]
											})
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
											asChild: true,
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
												to: "/countries",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Earth, { className: "mr-2 h-4 w-4 text-primary" }), " 40+ Destinations"]
											})
										})
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "animate-fade-up mt-12 grid grid-cols-2 gap-4 border-t border-slate-200/80 pt-6 sm:grid-cols-3",
									children: [
										{
											icon: Earth,
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-8 flex items-center justify-between border-t border-border/80 pt-6",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-xs text-muted-foreground hidden sm:block",
					children: "Need specialized consular or corporate filing assistance?"
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative overflow-hidden rounded-2xl border border-blue-200/90 bg-gradient-to-br from-blue-50/90 via-sky-50/50 to-white p-6 sm:p-10 shadow-xl backdrop-blur-xl",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "inline-flex items-center gap-1.5 rounded-full border border-blue-200 bg-blue-100/80 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-blue-700",
				...
				className: "mt-8 grid gap-4 sm:grid-cols-3 border-t border-slate-200/80 pt-6",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PlaneTakeoff, { className: "h-5 w-5 text-blue-600 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/hotel-booking",
						className: "flex items-center gap-3 rounded-2xl border border-slate-200 bg-white/90 p-4 hover:border-blue-400 hover:bg-white transition-all shadow-xs group",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BedDouble, { className: "h-5 w-5 text-blue-600 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-sm font-semibold text-slate-900 group-hover:text-blue-600 transition-colors",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-5 w-5 text-emerald-600 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-sm font-semibold text-slate-900 group-hover:text-emerald-600 transition-colors",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative overflow-hidden rounded-2xl border border-blue-200/90 bg-gradient-to-br from-blue-50/80 via-indigo-50/40 to-white p-8 text-center sm:p-14 shadow-xl",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					"aria-hidden": true,
					className: "animate-float absolute right-8 top-8 text-5xl opacity-15 text-blue-600",
					children: "✈"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "inline-flex items-center gap-1.5 rounded-full border border-blue-200 bg-blue-100/90 px-3 py-1 text-xs font-bold uppercase tracking-widest text-blue-700",
					children: "Start Your Journey"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "mt-4 font-display text-2xl font-bold text-slate-900 sm:text-4xl",
					children: "Where would you like to travel next?"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mx-auto mt-3 max-w-xl text-sm text-slate-600 sm:text-base leading-relaxed",
