...
function VisaPage() {
  ...
  return (
    <Section>
      ...
      <div className="mb-10 flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-border bg-gradient-to-r from-card via-card to-primary/5 p-5 sm:p-6 shadow-sm">
      ...
      {selected ? (
        <div className="mb-10 flex items-center justify-between gap-4 rounded-2xl border border-blue-200/80 bg-gradient-to-r from-blue-50/80 via-white to-blue-50/40 p-6 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <span>•</span>
                <span className="text-emerald-700 font-semibold">{selected.processingTime}</span>
              </p>
            </div>
          </div>
          <span className="hidden sm:inline-flex items-center gap-1 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700">
